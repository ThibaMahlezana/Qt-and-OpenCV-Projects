...
CaptureThread:: CaptureThread(int camera, QMutex *loock): running(false), cameraID(camera), videoPath(""), data_lock(lock){
...
void CaptureThread::run(){
    ...
    classifier = new cv::CascadeClassifier(OPENCV_DATA_DIR "haarcascade_frontalface_default.xml");
    mark_detector = cv::face::createFacemarkLBF();
    QString model_data = QApplication::instance()->applicationDirPath() + "lbfmodel.yaml";
